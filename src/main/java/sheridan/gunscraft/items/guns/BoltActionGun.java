...
public class BoltActionGun extends GenericGun{
    public BoltActionGun(Properties properties, int baseMagSize, boolean canHoldInOneHand, ResourceLocation[] textures,
        ...
        super(properties, baseMagSize, canHoldInOneHand, textures, fireModes, baseSpread, maxSpread, spreadPreShoot, bulletSpeed, baseDamage, minDamage, bulletLifeLength, shootDelay, normalFireSound, soundArgs, isFreeBlot, isPistol, reloadLength, burstCount, aimingSpeed, recoilUp, recoilRandom, recoilDec);
    }
}
